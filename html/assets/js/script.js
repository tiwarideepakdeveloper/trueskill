...
!(function ($) {
  ...
  var testimonialSlider1 = new Swiper("#testimonial-slider-1", {
    ...
    on: {
      init: function () {
        ...
        pagination.find(".min").text(currentSlide + 1);
        pagination.find(".max").text(paginationLength.length);
      },
      slideChange: function () {
        var pagination = $("#testimonial-slider-1-pagination"),
          currentSlide = this.activeIndex;

        pagination.find(".min").text(currentSlide);
      },
    },
  });
  ...
  /*============================================
        Price range
    ============================================*/
  var filterSliders = document.querySelector(
    "[data-range-slider='filterPriceSlider']",
  );
...
emailToast.setAttribute(
  "class",
  "toast-container position-fixed bottom-0 end-0 p-3 m-3",
);
